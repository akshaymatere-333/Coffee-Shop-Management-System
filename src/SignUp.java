...
public class SignUp extends javax.swing.JFrame {
    ...
    public void validateFields() {
        ...
        if (!name.equals("") && email.matches(emailPattern) && mobileNumber.matches(MobileNumberPattern)
                && mobileNumber.length() == 10 && !address.equals("") && password.matches(passwordPattern)
    ...
    private void txtPasswordMouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_txtPasswordMouseClicked
        ...
        JOptionPane.showMessageDialog(null,
                "Password Must Contain at least one Small letter,one Capital letter,one Digit and one special Character \n password must be greater than eight character");
